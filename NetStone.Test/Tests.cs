...
public class Tests
{
    ...
    public async Task CheckFreeCompany()
    {
        ...
        Assert.GreaterOrEqual(fc.ActiveMemberCount, 32);
    ...
    public async Task CheckFreeCompanyRecruiting()
    {
        ...
        Assert.IsTrue(fc.Slogan.StartsWith("The kindred souls"));
    ...
    public async Task CheckCharacterFull()
    {
        ...
        Assert.IsNull(gear.Mainhand.Dye1Name);
        Assert.IsNull(gear.Mainhand.Dye2Name);
